      ...
      <Main accessible={true}>
        <TextView accessible={true}>
          <TopBar>
            My Cart{' '}
            <ItemsSubscript>
              ({cartItems.productReducer.cartItems.length} items)
            </ItemsSubscript>
          </TopBar>
        </TextView>
        <FlatList
                ...
                <ContainerCart accessible={true}>
                  ...
                  <Increments accessible={true}>
                    <View style={{width: '15%'}}>
                      <ButtonCart
                        accessible={true}
                        accessibilityLabel="Press to decrement!"
                        color="#bf2957"
                    ...
                    <View style={{width: '15%'}}>
                      <ButtonCart
                        accessible={true}
                        accessibilityLabel="Press to increment"
                        color="#bf2957"
        ...
        <CheckOutView>
          ...
          <CheckOutButton
            ...
            <InnerText style={{justifyContent: 'space-around'}}>
              ...
              <Text1>{billedAmount.productReducer.billAmount}.Rs</Text1>
            </InnerText>
          </CheckOutButton>
        </CheckOutView>
      </Main>
